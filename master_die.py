...
numbers = {"one": [0, 0, 0, 1, 0, 0, 0], "two": [0, 1, 0, 0, 0, 1, 0],
...
while True:
    ...
    # message must be in format 'number colour' e.g. 'three red' or 'two green'
    while message is None:
        ...
        message = radio.receive()
    try:
        # split message into ["number", "colour"] e.g. ["three", "red"] & show
        roll = message.split()
